                ...
                <div class="col">
                    ...
                    <div class="ribbon-wrapper ribbon-lg">
                        ...
                        <div class="text-center">
                            <h3><b>SELAMAT {{ strtoupper(Auth::user()->name) }} ANDA LULUS PADA <br>
                            PROGRAM STUDI {{ strtoupper($lulus->prodi->jenjang) }} {{ strtoupper($lulus->prodi->nama) }} 
                            <br>KELAS {{ strtoupper($lulus->kelas->nama) }}</b>
                            </h3>
                        </div>
                    </div>
                </div>
