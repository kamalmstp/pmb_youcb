        ...
        <div class="row">
            <div class="col">
              <div class="form-group">
                ...
                <select name="prodi_id" id="prodi_id" class="select2bs4" style="width: 100%;">
            ...
            <div class="col">
              <div class="form-group">
                <label>Gelombang</label>
                <select name="kelas_id" id="kelas_id" class="select2bs4" style="width: 100%;">
                    <option value="">-Semua-</option>
...
<script>
    $(function () {
        ...
        $("#th_akademik_id").on('change',function(){
            ...
            var url = "{{url($url)}}";
            $.get(url + '/' + th_akademik_id + '/listGelombang', function (data) {
