  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @php
        $array_master = ['admin/agent_lembaga','admin/agent_lembaga/*','admin/agent_individu','admin/agent_individu/*','admin/agent_youcb','admin/agent_youcb/*'];
        @endphp
        <li class="nav-item has-treeview {{ (request()->is($array_master)) ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/agent_youcb') }}" class="nav-link {{ (request()->is(['admin/agent_youcb','admin/agent_youcb/*'])) ? 'active' : '' }}">
            ...
            <li class="nav-item">
              <a href="{{ url('admin/agent_lembaga') }}" class="nav-link {{ (request()->is(['admin/agent_lembaga','admin/agent_lembaga/*'])) ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>AGENT LEMBAGA</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="{{ url('admin/agent_individu') }}" class="nav-link {{ (request()->is(['admin/agent_individu','admin/agent_individu/*'])) ? 'active' : '' }}">
                <i class="far fa-circle nav-icon"></i>
                <p>AGENT INDIVIDU</p>
              </a>
            </li>
